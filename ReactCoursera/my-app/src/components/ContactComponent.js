...
class Contact extends Component {
    ...
    valdiate(firstname, lastname, telnum, email) {
        const errors = {
            firstname:'',
            lastname:'',
            telnum:'',
        ...
        if(this.state.touched.email && email.split('').filter(x => x==='@').lenght !== 1)
            errors.email = 'Email email should contain a @';
    ...
    render() {
        ...
        const errors = this.valdiate(this.state.firstname, this.state.lastname, this.state.telnum, this.state.email);
